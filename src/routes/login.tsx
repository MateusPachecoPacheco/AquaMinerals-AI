      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-16">
        ...
        >
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Entre para acessar seus painéis e insights.
          </p>

          <div className="mt-8">
            <p className="text-sm text-muted-foreground">
              Entre com seu e-mail e senha para acessar seus painéis e insights.
            </p>
          </div>
        ...
        <div className="relative flex h-full flex-col justify-between p-16 text-white">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-white/80">
              A plataforma da AquaMinerals conecta ciência, tecnologia e comunidade para uma nova
              era da economia azul.
            </p>
          </div>
