  ...
  head: () => ({
    meta: [
      ...
      { title: "AquaMinerals — Inteligência Oceânica Sustentável" },
      {
        name: "description",
        content:
          "Plataforma de monitoramento ambiental, análise mineral e economia azul. Ciência, tecnologia e comunidade a serviço do oceano.",
      },
      { name: "author", content: "AquaMinerals" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        <HeadContent />
        {/* Script inline: aplica tema ANTES do React carregar (evita flash branco) */}
        <script
