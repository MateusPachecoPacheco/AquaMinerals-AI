  ...
  head: () => ({
    meta: [
      { title: "Sobre — AquaMinerals" },
      {
        name: "description",
        content:
          "Nossa missão de transformar dados oceânicos em ferramentas de sustentabilidade e economia azul.",
      },
    ],
  }),
  component: About,
      ...
      <section className="relative overflow-hidden bg-gradient-hero py-24 sm:py-32">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h1 className="font-display text-4xl font-bold sm:text-6xl">
            Ciência oceânica <span className="text-gradient-ocean">acessível</span> e
            transformadora.
          </h1>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            {timeline.map((t, i) => (
              ...
              >
                <div
                  className={`absolute top-2 h-4 w-4 rounded-full bg-gradient-ocean shadow-glow ${i % 2 ? "left-2 md:-left-2" : "left-2 md:-right-2 md:left-auto"}`}
                />
