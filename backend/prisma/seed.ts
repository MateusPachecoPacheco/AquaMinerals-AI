...
async function main() {
    ...
    data: [
      {
        ...
        description:
          "Área próxima ao cais, monitorada para extração de sais minerais e análise de impacto ambiental.",
        latitude: -12.7415,
        longitude: -38.6218,
        salinityLevel: 35.2,
        phLevel: 8.1,
      },
      {
        name: "Ponta do Padre",
        description:
          "Ponto de coleta em área de manguezal, rico em biodiversidade e minerais dissolvidos.",
        latitude: -12.752,
        longitude: -38.615,
        salinityLevel: 34.8,
        phLevel: 8.0,
      },
      {
        ...
        description:
          "Área de mar aberto na Baía de Todos-os Santos, ideal para coleta de água com alta pureza para extração de Magnésio.",
        latitude: -12.728,
        longitude: -38.605,
        salinityLevel: 36.1,
        phLevel: 8.2,
    ...
    data: [
      {
        ...
        description:
          "Identificada mancha escura na superfície da água, possível descarte irregular de efluentes. Forte odor.",
      ...
      },
      {
        ...
        description:
          "Sugiro que a plataforma inclua um projeto de conscientização sobre microplásticos nas praias locais.",
      ...
      },
      {
        ...
        description:
          "A comunidade local organizou um mutirão de limpeza e a praia está impecável. Parabéns à iniciativa!",
    ...
    data: [
      {
        ...
        description:
          "Entenda como o magnésio é extraído de forma sustentável e sua importância para a indústria farmacêutica.",
        imageUrl:
          "https://images.unsplash.com/photo-1530030078344-81e9f6b9025c?auto=format&fit=crop&q=80&w=800",
        status: ProjectStatus.PUBLISHED,
      },
      {
        title: "Manguezais de Madre de Deus: Berçário e Filtro Natural",
        description:
          "Estudo sobre como os manguezais protegem a costa e filtram impurezas, mantendo o equilíbrio mineral.",
        imageUrl:
          "https://images.unsplash.com/photo-1589396254854-fd97a28e3c6d?auto=format&fit=crop&q=80&w=800",
        status: ProjectStatus.PUBLISHED,
      },
    ],
    skipDuplicates: true,
  ...
  await prisma.dashboardIndicator.createMany({
    data: [
      {
        metricName: "Sal Extraído (Toneladas)",
        value: 145.5,
        unit: "t",
