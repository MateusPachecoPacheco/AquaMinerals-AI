...
export class MockAiProvider implements IAiProvider {
  ...
  async generateResponse(prompt: string, _context?: string): Promise<string> {
    ...
    if (
      ...
      lowerPrompt.includes("ácido") ||
      lowerPrompt.includes("alcalino")
    ) {
